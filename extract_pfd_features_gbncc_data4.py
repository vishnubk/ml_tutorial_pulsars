...
data_object_nonpulsars = [pfddata(f) for f in pfd_files_nonpulsars[triple_max_value:quadruple_max_value]] 
...
np.save('time_phase_gbncc_test_data_nonpulsars_part4.npy', time_phase_plots_nonpulsars) 

#np.save('freq_phase_gbncc_test_data_pulsars.npy', freq_phase_plots_pulsars) 
np.save('freq_phase_gbncc_test_data_nonpulsars_part4.npy', freq_phase_plots_nonpulsars) 

#np.save('pulse_profile_gbncc_test_data_pulsars.npy', pulse_profile_pulsars) 
np.save('pulse_profile_gbncc_test_data_nonpulsars_part4.npy', pulse_profile_nonpulsars) 

#np.save('dm_curve_gbncc_test_data_pulsars.npy', dm_curve_pulsars) 
np.save('dm_curve_gbncc_test_data_nonpulsars_part4.npy', dm_curve_nonpulsars) 
t1 = time.time()
